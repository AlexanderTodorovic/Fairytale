...
params = urllib.parse.quote_plus("DRIVER={SQL Server};SERVER=rm-gs54sy6582h76ysz1.mssql.singapore.rds.aliyuncs.com,3433;DATABASE=fairytale;UID=brucelee;PWD=Lee2017#*fist")
