...
params = urllib.parse.quote_plus("DRIVER={SQL Server};SERVER=sqlms2017xela.westeurope.cloudapp.azure.com,1433;DATABASE=fairytale;UID=brucelee;PWD=Lee2017#*fist")
